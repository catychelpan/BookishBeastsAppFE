...
const SelectNoteRepetitionGroups = () => {
    ...
    const { setQuote, quote: { repetitionGroups } } = useContext(UserContext);
    ...
    const handleSave = () => {
        ...
        setQuote(prev => ({...prev, repetitionGroups: collections}))
        router.back();
    }
...
export default SelectNoteRepetitionGroups;