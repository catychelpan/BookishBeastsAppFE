...
import { DiscoBallIcon } from "../../components/Svg";
            ...
            <ScrollView>
                    ...
                    className="mt-5 mx-5 relative h-[317px] border-[#8A8A8A] rounded-[20px] border-[.5px] py-3 px-4">
                        <View className="flex-row">
                            ...
                            <View className="bg-[#E6E6E6] max-w-[95px] mt-4 max-h-[25px] w-full h-full justify-center items-center rounded-[13px]">
                                <Text className="text-sm text-[#1C1C1C] font-cygrebold leading-[16.8px] text-center">{new Date().toLocaleDateString('de-DE')}</Text>
                            </View>
                        </View>
                    <TextInput
                        value={text}
                ...
                { note.quote ? (
                    ...
                    <TouchableOpacity
                        ...
                        className="my-2.5 mx-5 max-h-[106px] bg-black h-full flex-row rounded-[20px]">
                        <View className="mx-7 self-center">
