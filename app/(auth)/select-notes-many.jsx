...
const SelectNotesMany = () => {
    ...
    const { repetitionGroup, setRepetitionGroup } = useContext(UserContext);
    ...
    const handleSave = () => {
        ...
        setRepetitionGroup(prev => ({...prev, notes: selectedNotes}))
        router.back();
    }
...
export default SelectNotesMany;
